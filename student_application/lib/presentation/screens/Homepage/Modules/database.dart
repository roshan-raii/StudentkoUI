...
class Database extends StatelessWidget {
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  "A database module facilitates interactions between software applications and databases, managing data storage, retrieval, and manipulation operations.",
  ...
  //         children: [
  //           Text(
  //             "Click on icon to rate module leader",
  //             style: GoogleFonts.redHatDisplay(textStyle: TextStyle()),
  //           ),
  //           Row(
  //             mainAxisAlignment: MainAxisAlignment.end,
